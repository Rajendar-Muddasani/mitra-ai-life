...
Output: content/assets/videos/level-10-intro.mp4
"""
...
AUDIO_DIR = ROOT / "content/assets/videos/audio_tmp_l10"
OUT       = ROOT / "content/assets/videos/level-10-intro.mp4"
...
def build_video():
    ...
    print(f"\nNext - upload to S3:")
    print(f"  source .env && aws s3 cp {OUT} s3://mitra-ai-life-assets/videos/level-10-intro.mp4 --content-type 'video/mp4' --cache-control 'public, max-age=86400'")
